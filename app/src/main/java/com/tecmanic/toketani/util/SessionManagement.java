...
import static com.tecmanic.toketani.config.BaseURL.APP_OTP_STATUS;
import static com.tecmanic.toketani.config.BaseURL.CART_ID_FINAL;
import static com.tecmanic.toketani.config.BaseURL.COUNTRY_CODE;
import static com.tecmanic.toketani.config.BaseURL.IS_LOGIN;
import static com.tecmanic.toketani.config.BaseURL.KEY_EMAIL;
import static com.tecmanic.toketani.config.BaseURL.KEY_HOUSE;
import static com.tecmanic.toketani.config.BaseURL.KEY_ID;
import static com.tecmanic.toketani.config.BaseURL.KEY_IMAGE;
import static com.tecmanic.toketani.config.BaseURL.KEY_MOBILE;
import static com.tecmanic.toketani.config.BaseURL.KEY_NAME;
import static com.tecmanic.toketani.config.BaseURL.KEY_PASSWORD;
import static com.tecmanic.toketani.config.BaseURL.KEY_PAYMENT_METHOD;
import static com.tecmanic.toketani.config.BaseURL.KEY_PINCODE;
import static com.tecmanic.toketani.config.BaseURL.KEY_REWARDS_POINTS;
import static com.tecmanic.toketani.config.BaseURL.KEY_SOCITY_ID;
import static com.tecmanic.toketani.config.BaseURL.KEY_SOCITY_NAME;
import static com.tecmanic.toketani.config.BaseURL.KEY_WALLET_AMMOUNT;
import static com.tecmanic.toketani.config.BaseURL.MAP_SELECTION;
import static com.tecmanic.toketani.config.BaseURL.PAYMENT_PAYPAL;
import static com.tecmanic.toketani.config.BaseURL.PAYMENT_PAYSTACK;
import static com.tecmanic.toketani.config.BaseURL.PAYMENT_RAZORPZY;
import static com.tecmanic.toketani.config.BaseURL.TOTAL_AMOUNT;
import static com.tecmanic.toketani.config.BaseURL.USER_CITY;
import static com.tecmanic.toketani.config.BaseURL.USER_CURRENCY;
import static com.tecmanic.toketani.config.BaseURL.USER_CURRENCY_CNTRY;
import static com.tecmanic.toketani.config.BaseURL.USER_EMAIL_SERVICE;
import static com.tecmanic.toketani.config.BaseURL.USER_INAPP_SERVICE;
import static com.tecmanic.toketani.config.BaseURL.USER_LANG;
import static com.tecmanic.toketani.config.BaseURL.USER_LAT;
import static com.tecmanic.toketani.config.BaseURL.USER_OTP;
import static com.tecmanic.toketani.config.BaseURL.USER_SKIP;
import static com.tecmanic.toketani.config.BaseURL.USER_SMS_SERVICE;
import static com.tecmanic.toketani.config.BaseURL.USER_STATUS;
import static com.tecmanic.toketani.config.BaseURL.USER_STOREID;
