...
import com.tecmanic.toketani.adapters.AdapterPopup;
...
import static com.tecmanic.toketani.config.BaseURL.PRODUCT_VARIENT;
...
public class ProductDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferences = getSharedPreferences("toketani", Context.MODE_PRIVATE);
        init();
